      ...
      <div className="card mb-5 mb-lg-0">
        <div className="card-body">
          ...
          <h6 className="card-price text-center">
           {data.amount}<span className="period">/month</span>
          </h6>
          <hr />
          <ul className="fa-ul">
            ...
            <li className={data.isAccess?"":"text-muted"}>
              <span className="fa-li">
              <i className={data.isAccess?"fas fa-check":"fas fa-times"}></i>
              </span>
              {data.access}
            </li>
            ...
            <li className={data.isSubdomian?"":"text-muted"}>
              <span className="fa-li">
              <i className={data.isSubdomian?"fas fa-check":"fas fa-times"}></i>
              </span>
              {data.subdomain}
            </li>
            <li className={data.isReports?"":"text-muted"}>
              <span className="fa-li">
              <i className={data.isReports?"fas fa-check":"fas fa-times"}></i>
              </span>
              {data.reports}
            </li>
          </ul>
